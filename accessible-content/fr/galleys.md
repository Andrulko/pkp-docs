...
![Capture d'écran du menu Acrobat Pro DC pour créer PDF à partir d'un fichier.](./assets/9_a11y-guide-create-pdf-pro1.png)
...
On Mac: Open the **File** application menu and select **Save As…** Under **File Format**, select “PDF”. <stronga x-id="1">.
